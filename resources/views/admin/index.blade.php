...
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<a href="{{ route('admin.blogs') }}" class="btn btn-warning btn-margin-right">Published/Drafts</a>

		<a href="{{ route('users.index') }}" class="btn btn-info btn-margin-right white-text">Manage Users</a>
